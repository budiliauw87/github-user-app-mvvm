 ...
 */
public class AdapterFavorite extends PagingDataAdapter<UserEntity, AdapterFavorite.UserViewHolder> {
    ...
    public void onBindViewHolder(@NonNull AdapterFavorite.UserViewHolder holder, int position) {
        User user = DataMapper.mapEntityToDomain(getItem(position));
        // Check for null
        holder.bind(user);
    }
