...
import com.liaudev.dicodingfa.BaseActivity;
import com.liaudev.dicodingfa.GlideApp;
import com.liaudev.dicodingfa.R;
import com.liaudev.dicodingfa.adapter.SectionsPagerAdapter;
import com.liaudev.dicodingfa.data.room.User;
import com.liaudev.dicodingfa.databinding.ActivityDetailBinding;
...
public class DetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DetailViewModel detailViewModel = new ViewModelProvider(this, (ViewModelProvider.Factory) factory).get(DetailViewModel.class);
        ...
        if (user != null) {
            ...
            RequestBuilder<Drawable> requestBuilder = GlideApp.with(DetailActivity.this)
            ...
            new TabLayoutMediator(tabs, viewPager2, (tab, position) -> {
                ...
                if (position == 0) {
                    ((TextView) v.findViewById(R.id.tabTitle)).setText(String.valueOf(user.getFollower()));
                    ((TextView) v.findViewById(R.id.tabSubTitle)).setText(getString(R.string.follower));
                } else if (position == 1) {
                    ((TextView) v.findViewById(R.id.tabTitle)).setText(String.valueOf(user.getFollowing()));
            ...
            detailViewModel.getUser(user.getId()).observe(this, entity -> {
                if (entity == null) {
