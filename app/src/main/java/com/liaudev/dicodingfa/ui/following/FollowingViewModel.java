...
public class FollowingViewModel extends ViewModel {
    ...
    private final int METHOD_QUERY_FOLLOWING = 2;

    public FollowingViewModel(DataRepository repository) {
    ...
    public LiveData<PagingData<User>> getFollowers() {
        ...
        return PagingLiveData.cachedIn(PagingLiveData.getLiveData(dataRepository.getUsers(queryLiveData.getValue(), METHOD_QUERY_FOLLOWING)), coroutineScope);
    }
