...
import com.liaudev.dicodingfa.databinding.FragmentFollowerBinding;
...
public class FollowerFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        followerViewModel = new ViewModelProvider(this, (ViewModelProvider.Factory) factory).get(FollowerViewModel.class);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if(args!=null){
            ...
            followerViewModel.setLoginName(loginName);
        }

        followerViewModel.getFollowers().observe(getViewLifecycleOwner(), (pagingData -> {
